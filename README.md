...
`github-snapshot` is read-only. It does not push, open or edit a pull request, comment, resolve a thread, or rerun a check. Remote finish lines remain unsupported until those mutations use the durable side-effect journal.
