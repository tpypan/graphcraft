...
catalogs; [marketplace distribution](https://github.com/tpypan/graphcraft/blob/v0.1.3/docs/MARKETPLACES.md) records their validation and the
...
The [v0.1 implementation report](https://github.com/tpypan/graphcraft/blob/v0.1.3/docs/V0.1.md) records the acceptance boundary, architecture, tests, real-host dogfood, and known gaps. Research and competitive rationale live under [docs/research](https://github.com/tpypan/graphcraft/tree/v0.1.3/docs/research).
