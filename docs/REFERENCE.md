# Graphcraft v0.1 reference

The detailed install, capability, and command reference for the v0.1 alpha. The [README](../README.md) is the short overview; this page preserves the full operational detail.
...
```bash
GRAPHCRAFT_VERSION=<released version>
...
catalogs; [marketplace distribution](MARKETPLACES.md) records their validation and the
...
The [v0.1 implementation report](V0.1.md) records the acceptance boundary, architecture, tests, real-host dogfood, and known gaps. Research and competitive rationale live under [research](research).
